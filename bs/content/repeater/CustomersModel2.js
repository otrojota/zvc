class CustomersModel2 {
    constructor(n) {
        this.customers = [];
        for (let i=1; i<=n; i++) {
            this.customers.push({id:"cust_" + i, name:"Customer " + i, active:(i % 5?true:false), address:"Address of Customer " + i + ", Street Name, block, dept. and extra indications"});
        }
    }
